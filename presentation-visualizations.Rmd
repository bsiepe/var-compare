...
Updated some of these for IMPS2024.
```{r}
...
plot_dec_rule_prior_sens_present <- df_comp_res %>% 
  ...
  theme(
    ...
    legend.title = ggplot2::element_text(face = "plain", size = ggplot2::rel(1.5)),
...
ggsave(filename ="plot_dec_rule_prior_sens_present_rev1.svg",plot_dec_rule_prior_sens_present, device = "svg",
         path = here::here("figures/revision1/"), width = 10, height = 6)
...
ggsave(filename = paste0("plot_false_positive_se_prior_sens_present_rev1.svg"),plot_false_positive_se_prior_sens, device = "svg",

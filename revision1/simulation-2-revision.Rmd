...
Compare all models: TODO this has to change if we rerun the sim again, too many unneccessary comparisons. 
```{r}
# Setup list of conditions
# number of data-generating processes
n_dgp <- 5
...
ncores <- 3
cl <- makeCluster(ncores)
clusterExport(cl, c("comp_grid",  "comp_grid_mod", "within_compare", "post_distance_within", "here", "todo_files_num"))
clusterEvalQ(cl, library(tidyverse))

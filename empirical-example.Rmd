...
l_comps_1 <- foreach(i = 1:nrow(fit_grid_1)) %dopar% {
  ...
  saveRDS(comp_res, file = here::here("output/empirical-example/test-individual-files", paste0("comp_res_", i, ".rds")))
  return(comp_res)
...
saveRDS(df_comps, file = here::here("data/empirical_example/df_comps_cubicspline_rev1.RDS"))
...
# Samples from prior
b41_prior <- rnorm(length(b41_post), 0, 0.5)

...
for(n in 1:nrow(cond_grid)) {
  ...
  l_res[[n]]  <- fit_var_parallel_merged(l_raw[[dgp_ind]][[tp_ind]],
                          rho_prior = r_sd,
                          beta_prior = b_sd,
                          iterations = n_iter,
                          n = 1000,
...
# saveRDS(l_res_bggm, here::here("output/bggm-var-sim-res_1203.Rds"))
l_res_bggm <- readRDS(here::here("output/bggm-var-sim-res_1203.Rds"))
...
# saveRDS(l_res_gvar, here::here("output/graphicalvar-sim-res_1203.Rds"))
l_res_gvar <- readRDS(here::here("output/graphicalvar-sim-res_1203.Rds"))

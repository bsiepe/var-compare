...
df_eval_bggm_wide <- df_eval_bggm %>% 
  ...
  pivot_wider(names_from = ci_ci, values_from = c(ci_sum_cover_beta, ci_sum_cover_pcor,
                                               ci_width_beta,ci_width_pcor, ci_true_pos_beta, ci_true_pos_pcor, ci_fal_pos_beta, ci_fal_pos_pcor, ci_true_neg_beta, ci_true_neg_pcor, ci_fal_neg_beta,
  ci_fal_neg_pcor,
  ci_sens_beta, ci_sens_pcor, ci_spec_beta, ci_spec_pcor))
rm(df_eval_bggm)
rm(l_eval_bggm)
...
```{r}
plot_eval_bggm <- df_eval_both_long %>% 
...
ggsave("plot_eval_bggm.svg", plot_eval_bggm, height = 9, width = 12, path = here::here("figures/"), device = "svg")

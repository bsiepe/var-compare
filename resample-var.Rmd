...
df_comp_res <- readRDS(here::here("data/df_comp_res_0205.RDS"))
...
plot_dec_rule_box
ggsave(filename = "plot_dec_rule_box.svg",plot_dec_rule_box, device = "svg", path = here::here("figures/"), width = 14, height = 12)
```

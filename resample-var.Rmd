...
This code will not work anymore, because results are now stored differently. Have to add "$fit"
...
# TODO add storage of information about dataset, so which dgp etc.
# TODO maxdiff throws an error here - results from missings in l_res
# TODO we only want to compare within time points... this also compares across timepoints, I think

...
# needs to be c(1:nrow(comp_grid))
# this can be done with parlapply
# done unteil 83!!!
...
# TODO exchange with nrow(comp_grid)
parLapply(cl = cl, c(todo_files_num), function(n){
...
TODO not sure if within_compare_eval works correctly yet...
```{r}

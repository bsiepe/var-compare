...
# without and contemporaneous connections

graph <- randomGVARmodel(Nvar = 6, probKappaEdge = 0, probBetaEdge = .5)
dat <- graphicalVARsim(200, beta = graph$beta, kappa = graph$kappa)
...
# compute prediction error for refitting the model
# where are the intercepts in the var_estimate output? They are missing!
predict_bggm <- function(x){

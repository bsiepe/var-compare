...
plot_test_null_dist
ggsave(filename = "plot_test_null_dist_wide.svg",plot_test_null_dist, device = "svg",
...
plot_dec_rule_prior_sens <- df_comp_res %>% 
         ...
         dplyr::mutate(change = case_match(
          ...
          dplyr::mutate(mat = case_when(
            grepl("beta05", res) ~ "Temporal",
            grepl("pcor05", res) ~ "Contemp.")) %>%  
          ggplot(aes(x = tp, y = value, linetype = prior, group = prior)) + 

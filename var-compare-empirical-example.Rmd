...
posterior_plot <- function(object,
  ...
  beta_plot <- beta %>% 
    ...
    ggdist::stat_slab(aes(fill = after_stat(level)), .width = c(cis, 1)) +
...
plot_example_posterior <- posterior_plot(fit)

ggsave("plot_example_posterior.svg", plot_example_posterior, 

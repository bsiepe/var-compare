...
l_comps <- foreach(i = 1:nrow(fit_grid_3)) %dopar% {
...
df_comps_1 <- do.call(rbind, l_comps)
df_comps_2 <- do.call(rbind, l_comps)
df_comps_3 <- do.call(rbind, l_comps)

# Add prior information
df_comps_1c <- df_comps_1 %>% 
  cbind(fit_grid_1)
df_comps_2c <- df_comps_2 %>% 
  cbind(fit_grid_2)
df_comps_3c <- df_comps_3 %>% 
  cbind(fit_grid_3)



df_compsc <- as.data.frame(rbind(df_comps_1c, df_comps_2c, df_comps_3c))
...
# subelement_names <- c("larger_beta", "larger_pcor")
# l_comps_short <- list()
# 

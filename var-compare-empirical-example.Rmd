...
## Convergence 
Show this for prior 2 only
```{r}
# # Trace Plots
BGGM::convergence(l_fits_c[[1]][[1]], type = "trace",  param = "concentrate--positive")
# 
# # ACF
BGGM::convergence(l_fits[[1]][[1]], type = "acf", param = "concentrate--positive")
# 
# 
...
p12_temp <- qgraph::qgraph(fit_12$beta_mu, theme = "colorblind", layout = "circle",
                           color = ggokabeito::palette_okabe_ito()[1], maximum = max_sc)
dev.off()

svg(filename = "figures/empirical_network_18t.svg")
p18_temp <- qgraph::qgraph(fit_18$beta_mu, theme = "colorblind", layout = "circle",
                           color = ggokabeito::palette_okabe_ito()[2], maximum = max_sc)
dev.off()

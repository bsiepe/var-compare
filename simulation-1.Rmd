...
ls_eval_bggm_both_plots[[1]] <- ggplot(data = ls_data_eval_bggm$Bias, 
  ...
  geom_linerange(aes(ymin = value - 1*mcse,
                            ymax = value + 1*mcse),
                        width = .5, 
...
ggsave("plot_eval_both_bias.svg", plot_bias, 
       height = 8, width = 11, path = here::here("figures/"), device = "svg")
...
plot_ci_sens <- df_eval_bggm %>% 
  ...
  geom_line()+
  geom_linerange(aes(ymin = mean_stat - 1*mean_mcse,
